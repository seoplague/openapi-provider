...
namespace Geocoder\Provider\OpenApi;
...
use Geocoder\Provider\OpenApi\Model\OpenApiAddress;
 ...
 */
final class OpenApi extends AbstractHttpProvider implements Provider
{
    /**
     * @var string
     */
    public const GEOCODE_ENDPOINT_URL = 'https://geocoding.openapi.it/geocode';

    /**
     * @var string
     */
    public const REVERSE_ENDPOINT_URL = 'https://geocoding.openapi.it/reverse';
     ...
     */
    public function __construct(ClientInterface $client, Guzzle $guzzle, string $apiKey = null)
    {
    ...
    public function geocodeQuery(GeocodeQuery $query): Collection
    {
        ...
        if (filter_var($address, FILTER_VALIDATE_IP)) {
            throw new UnsupportedOperation('The OpenApi provider does not support IP addresses, only street addresses.');
        }
    ...
    private function executeQuery(string $url, int $limit, string $locale = null): AddressCollection
    {
        ...
        foreach ($data as $item) {
            ...
            /** @var OpenApiAddress $location */
            $location = $builder->build(OpenApiAddress::class);
    ...
    protected function getUrlContents($url, $data) {
